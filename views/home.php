<div id="home">
    <div class="align_mid" style="font-family:Fontin;top:120px">
            <h1 style="margin-left:90px;color:#fff;font-size:40px">Feed us the data and we'll deliver the analytics.</h1>
            <img src="images/home_3.png" style="width:230px; height:220px;margin-left:50px;margin-top:30px;position:absolute"/>
